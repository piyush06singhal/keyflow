...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute top-full left-0 flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      ref={ref}
      className={cn(
        "origin-top-center border-border bg-popover text-popover-foreground shadow-key-md relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-xl border md:w-[var(--radix-navigation-menu-viewport-width)]",
        className,
      )}
      {...props}
    />
